                ...
                <div className=" flex flex-col items-center text-center mt-24 md:mt-32">
                    <div className=" ">
                        ...
                        <p className="lg:text-xs xxs:text-sm md:text-sm text-[#333333] mb-8">
                            We’re on it! Porker Hut representative will be reaching out shortly.
                        </p>
                        <NavLink to="/" className=" border xxs:text-[14px] border-[#479559] md:text-[14px] text-[8px] md:py-3 md:px-10 py-4 px-[45px]  rounded-[4px] text-[#fff] bg-[#197B30] md:inline-block select-none tracking-wider font-medium whitespace-nowrap mt-6">
                            Back to Home Page
                        </NavLink>
                    </div>
                </div>

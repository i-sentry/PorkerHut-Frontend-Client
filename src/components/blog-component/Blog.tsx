...
const Blog = () => {
  return (
    <section className="w-full md:h-[600px] xxs:h-[1100px]">
      <div>
      ...
      <div className="w-full max-h-[1000px] md:grid md:grid-cols-2 md:gap-10 md:px-10 md:mt-10 xxs:grid-cols-1 xxs:px-3 ">

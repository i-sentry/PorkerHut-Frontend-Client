    ...
    return (
        ...
        <div className='px-6 py-6 bg-[#EEEEEE]'>
            ...
            <div className='md:grid md:gap-4 md:grid-cols-3 md:mt-10 bg-white px-6 py-6'>
                ...
                {ratingData.map(data => (
                    <div key={data.id} className='bg-[#F4F4F4] h-28 p-2 flex flex-col gap-3 rounded-sm xxs:mb-4 md:mb-0'>
                        ...
                        <div>
                            <span className=' text-sm'>Awesome products and swift delivery to my doorstep</span>
                        </div>
                    </div>

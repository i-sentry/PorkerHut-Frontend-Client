...
import AnimalFeedProductCard from "./AnimalFeedProductCard";

const AnimalFeedProduct = () => {
  const responsive = {
    superLargeDesktop: {
  ...
  return (
    <div className="md:h-[80vh]  mx-auto md:my-10 ">
      <div className=" xxs:px-2 xxs:py-2 md:px-8 flex justify-between items-center bg-[#197B30]">
        <h1 className="text-2xl font-medium text-white">Animal Feed</h1>
...
export default AnimalFeedProduct;

    ...
    <AppLayout>
      ...
      <div className="md:p-14 xxs:mt-7 md:mt-0 xxs:px-3 xxs:py-16 bg-[#F4F4F4] mb-16">
        <div className="md:max-w-[500px] ">
          <h1 className=" mb-4 md:font-medium md:leading-[47px] md:text-[32px] xxs:font-normal xxs:text-[20px] xxs:leading-[23px] text-[#333333]">
            Why choose Porkerhut?
          </h1>
          <p className=" md:leading-6 text-[14px] md:text-[14px] text-[#797979] xxs:text-[14px] xxs:leading-[24px] text-justify">
        ...
        <div className="md:grid md:grid-cols-3  md:gap-8">
          <div className=" bg-white rounded mt-12 px-8 py-10 shadow-md">
            ...
            <p className=" leading-6 text-[14px] md:text-[14px] text-[#797979] text-justify">

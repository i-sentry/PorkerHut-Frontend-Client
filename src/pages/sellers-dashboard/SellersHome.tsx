...
const SellersHome = () => {
  return (
    <>
      ...
      <div className="md:flex h-full mb-48 xxs:mb-80 gap-48">
        <div className="announcement-div h-[700px] w-[445px] md:w-[550px] border border-[#A2A2A2] mt-10">
          <div className=" bg-[#F4F4F4]">
          ...
          <div className=" p-7 my-5">
            ...
            <p className="text-sm text-[#333333] md:ml-12">
        ...
        <div className="pending-orders h-[700px] w-[445px] md:w-[550px] border border-[#A2A2A2] mt-10 ">
          <div className=" bg-[#F4F4F4]">
          ...
          <div className=" h-[271px] w-[445px] md:w-[550px] border border-[#A2A2A2]">
            <div className=" bg-[#F4F4F4]">

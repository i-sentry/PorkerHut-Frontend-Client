          ...
          >
            ...
            <div className="w-3/4 ml-8 py-4">
              <form
                ...
                className="space-y-2 " style={{ display: tab === 1 ? "block" : "none" }}
                ...
                >
                  <div className="grid grid-cols-2 gap-8">
                    ...
                    <div>
                      ...
                      <input
                        {...register("storeName")}
                        type="text" placeholder="Enter store name" className="border border-[#D9D9D9] py-[10px] px-[10px] text-xs  w-full focus:outline-none rounded-sm  placeholder-gray-500 text-gray-900" />
                  ...
                  <div className="grid grid-cols-2 gap-8">
                    <div className="w-full">
                      ...
                      <input
                        {...register("email")}
                        type="text" placeholder="Enter name" className="border border-[#D9D9D9] py-[10px] px-[10px] focus:outline-none text-xs  w-full rounded-sm  placeholder-gray-500 text-gray-900" />
                    </div>
                    <div>
                      ...
                      <input
                        ...
                        type="text" placeholder="Enter store name" className="border border-[#D9D9D9] py-[10px] px-[10px] w-full focus:outline-none rounded-sm text-xs  placeholder-gray-500 text-gray-900" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-8">
                    <div className="w-full">
                      ...
                      <input
                        ...
                        type="text" placeholder="Enter name" className="border border-[#D9D9D9] py-[8px] px-[10px] focus:outline-none w-full rounded-sm text-xs   placeholder-gray-500 text-gray-900" />
                    </div>
                    <div>
                      ...
                      <input
                        {...register("location")}
                        type="text" placeholder="Enter store name" className="border border-[#D9D9D9] py-[10px] px-[10px] w-full focus:outline-none text-xs  rounded-sm  placeholder-gray-500 text-gray-900" />
                    </div>
                  </div>
                  <div className="grid grid-cols-2 gap-8">
                    <div className="w-full">
                      ...
                      <input
                        ...
                        type="number" placeholder="Enter phone no." className="border border-[#D9D9D9] py-[10px] px-[10px] focus:outline-none w-full rounded-sm text-xs   placeholder-gray-500 text-gray-900" />
                    </div>

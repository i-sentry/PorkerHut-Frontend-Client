  ...
  return (
    <>
      <div className="flex justify-between items-start gap-9 mb-40 px-[80px] pt-[122px] w-full hide-scroll-bar">
        ...
        <div className="w-1/2 p-[50px] border-[#D9D9D9] border">
          <h2 className="text-black text-2xl font-medium mb-4">Create an account</h2>
          ...
          <form action="">
            <div>
              ...
              <input
                ...
                id="firstName"
                className={`rounded w-full p-3 pl-4  border border-[#D9D9D9] placeholder:text-sm placeholder:text-[#A2A2A2] active:border-[#197B30] focus-within:border-[#197B30] mt-1 focus:outline-none appearance-none focus:ring-[#197b30] ${
                  errors.firstName
            ...
            <div className="mt-6">
            <label htmlFor="" className="text-base font-normal mb-2">
                Role
              </label>
              <select name="role" id="role" className="w-full p-3 border border-[#D9D9D9] rounded-[4px] focus:outline-none  focus:border-[#197B30]">

        ...
        <div className="mt-3 flex justify-end">
          <label htmlFor="search" className="relative block w-[45%]">
            <input
              ...
              className="form-input inline-block w-full rounded-[8px] border-0 bg-[#F4F4F4] py-3.5 px-3 pl-6 outline-none ring-0 focus:border focus:border-green-700 focus:ring-0"
            />

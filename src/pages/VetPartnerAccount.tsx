          ...
          <nav className="mb-4 flex items-center justify-between">
            ...
            <div className="">
              <h1 className="mt-4 text-sm  font-medium text-[#A2A2A2]">
                Help Line: <br className="hidden lg:block" />
        ...
        <div className=" bg-[#eee] px-2 py-3 lg:px-[4%]">
          <ProductsBreadCrumbs
            items={[
              ...
              {
                name: "Vet Partner",
                link: "/affiliate/vet-partner-account",
              },
            ]}
          />
        </div>
        <div className="pb-20 xxs:hidden md:block">
          <div className="bg-[#197B30] xxs:my-[61px] md:my-[80px] md:mx-20 ">
            <div className="p-10">
              ...
              <p className="flex items-center justify-center text-[14px]   text-[#FFFFFF] md:text-[16px] md:leading-[150%] ">
                At Porker Hut, we believe in forging strong partnerships to
                deliver the highest level of care for our beloved pigs. We are
                excited to introduce our Vet Partner program designed to
                collaborate with veterinary professionals who share our
                commitment to responsible pig rearing and exceptional animal
                welfare.
              </p>
              <p className="mt-3 text-[14px]   text-[#FFFFFF] md:text-[16px] md:leading-[150%]">
                By becoming a Vet Partner with Porker Hut, you’ll join a network
                of dedicated experts in the field of veterinary medicine. As a
                Vet Partner, you will have the opportunity to work closely with
                our team of experienced pig farmers, nutritionists, and animal
                care specialists to ensure the health and well-being of our pigs
                throughout their journey from farm to table.
              </p>
            </div>
          </div>
